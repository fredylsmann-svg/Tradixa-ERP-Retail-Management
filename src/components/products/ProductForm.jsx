            ...
            <div className="bg-slate-50 p-4 border border-slate-200 rounded-xl space-y-4">
              <h4 className="text-sm font-semibold flex items-center gap-2">
                ...
                <div className="group relative ml-1 inline-block">
                  ...
                  <div className="hidden group-hover:block absolute z-[60] w-[280px] md:w-80 p-3 mt-1 text-xs text-white bg-slate-800 rounded shadow-lg left-1/2 -translate-x-[80%] md:-translate-x-1/2 top-full text-left space-y-2">
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20 p-4 border border-emerald-200 dark:border-emerald-800/60 rounded-xl space-y-4">
              <h4 className="text-sm font-semibold flex items-center gap-2">
                ...
                <div className="relative ml-1 inline-block">
                  ...
                  />
                  {showUomHelp && (
                    <div className="absolute z-[60] w-[300px] md:w-[480px] p-4 mt-1 text-xs text-white bg-slate-950/95 border border-slate-700 rounded-xl shadow-2xl left-1/2 -translate-x-[85%] md:-translate-x-1/2 top-full text-left space-y-3 backdrop-blur-sm">
              ...
              <div className="pb-2 md:pb-0">
                <div className="space-y-3 md:space-y-2">
                  {uomPrices.map((uom, index) => {
                    ...
                    return (
                      <div key={index} className={`grid grid-cols-2 md:flex md:items-end gap-3 md:gap-2 p-3 rounded-lg border relative ${isBase
                        ...
                        {!isBase && (
                          <div className="md:hidden absolute top-2 right-2">
                            <button
                              ...
                              className="h-8 w-8 flex items-center justify-center rounded-md text-red-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors"
                            >
                        ...
                        {/* Unit Name */}
                        <div className="col-span-1 md:flex-1 md:min-w-[100px]">
                        ...
                        {/* Qty per Base */}
                        <div className="col-span-1 md:w-[90px]">
                        ...
                        {/* Margin Info */}
                        <div className="col-span-1 md:w-[100px] text-left md:text-center">
                          <Label className="text-[11px] text-slate-500">Margin</Label>
                          <div className={`mt-1.5 h-9 flex items-center md:justify-center rounded-md text-xs font-semibold ${marginForUom < 0 ? 'text-red-600 bg-red-50 dark:bg-red-900/30' : 'text-emerald-600 bg-emerald-50 dark:bg-emerald-900/40'
                            }`}>
                        ...
                        <div className="hidden md:block w-[36px]">
                          {!isBase ? (
                            <button
                              type="button"
                              onClick={() => setUomPrices(prev => prev.filter((_, i) => i !== index))}
