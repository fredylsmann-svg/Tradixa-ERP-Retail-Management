...
export default function Header({ store, isSidebarOpen, setIsSidebarOpen, isMobileOpen, setIsMobileOpen }) {
  ...
  return (
    <header className="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 shadow-sm dark:shadow-none z-10 px-4 md:px-6 py-3 pt-[max(0.75rem,env(safe-area-inset-top))] flex-shrink-0 w-full">
