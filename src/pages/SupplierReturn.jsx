...
export default function SupplierReturn({ store }) {
  ...
  const handleSendToWA = (retur) => {
    ...
    const message = `Halo ${retur.supplier_name},\n\nKami ingin mengajukan pengembalian barang (Retur) dengan rincian berikut:\n\n*No. Retur:* ${retur.return_number}\n*Tanggal:* ${retur.timestamp_wib}\n\n*Daftar Barang:*\n${itemText}\n\nSilakan klik tautan di bawah ini untuk melihat bukti foto dan melakukan konfirmasi (Setujui/Tolak):\n${reviewLink}\n\nTerima kasih.`;
