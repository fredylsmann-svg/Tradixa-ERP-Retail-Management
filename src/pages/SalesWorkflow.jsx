        ...
        <CardContent className="p-8 relative z-10">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap sm:flex-nowrap gap-3 w-full sm:w-auto">
              <Button onClick={() => navigate('/SalesTransaction')} className="bg-white text-emerald-600 hover:bg-emerald-50 font-bold h-10 px-6 rounded-xl shadow-lg w-full sm:w-auto justify-center flex">
                Masuk POS Kasir
              </Button>
              <Button onClick={() => navigate('/RevenueReports')} variant="ghost" className="text-white hover:bg-white/10 font-bold h-10 px-6 rounded-xl border border-white/20 w-full sm:w-auto justify-center flex">
                Laporan Pendapatan
              </Button>
            </div>
          </div>
