...
const featureGroups = [
  {
    ...
    icon: BarChart3,
    features: [
      { name: 'Produk', free: '25', pro: '1.000', premium: '10.000', enterprise: 'Unlimited' },
      { name: 'Customer', free: '25', pro: 'Unlimited', premium: 'Unlimited', enterprise: 'Unlimited' },
      { name: 'Upload Foto/Media Produk', free: '10', pro: 'Hingga 500', premium: 'Hingga 5.000', enterprise: 'Unlimited' },
      { name: 'Max Ukuran Foto', free: '2 MB', pro: '2 MB', premium: '2 MB', enterprise: '10 MB' },
      { name: 'Email & Notifikasi (Email/WA)', free: false, pro: '50/bulan', premium: '300/bulan', enterprise: 'Unlimited' },
      { name: 'Purchase Requisition', free: false, pro: 'Unlimited', premium: 'Unlimited', enterprise: 'Unlimited' },
      { name: 'Purchase Order', free: false, pro: 'Unlimited', premium: 'Unlimited', enterprise: 'Unlimited' },
      { name: 'GRN', free: false, pro: 'Unlimited', premium: 'Unlimited', enterprise: 'Unlimited' },
      { name: 'Inventory GRN', free: false, pro: 'Unlimited', premium: 'Unlimited', enterprise: 'Unlimited' },
      { name: 'Supplier Return', free: false, pro: 'Unlimited', premium: 'Unlimited', enterprise: 'Unlimited' },
    ]
  },
  {
    title: 'Inventory',
    icon: Package,
    features: [
      { name: 'Product Master', free: '25 produk', pro: '1.000 produk', premium: '10.000 produk', enterprise: 'Unlimited' },
      { name: 'Location Settings', free: true, pro: true, premium: true, enterprise: true },
      { name: 'Stock In / Stock Out', free: true, pro: true, premium: true, enterprise: true },
      { name: 'Inventory Reports', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Inventory Ledger', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Low Stock Alert', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Inventory Workflow', free: false, pro: true, premium: true, enterprise: true },
      { name: 'User Management', free: false, pro: true, premium: true, enterprise: true },
    ]
  },
  {
    title: 'Sales',
    ...
    features: [
      ...
      { name: 'Sales Workflow', free: false, pro: true, premium: true, enterprise: true },
      { name: 'User Management', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Integrasi EDC Lokal', free: false, pro: false, premium: true, enterprise: true },
    ]
  },
  {
    title: 'Procurement',
    icon: Truck,
    features: [
      { name: 'Procurement Workflow', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Suppliers', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Purchase Orders', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Goods Receipt & GRN', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Purchase Invoices', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Supplier Return', free: false, pro: true, premium: true, enterprise: true },
    ]
  },
  {
    title: 'Warehouse (WMS)',
    icon: Warehouse,
    features: [
      { name: 'Warehouse Dashboard (Real-Time)', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Transfer Gudang (Inter-Branch)', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Pick List (Konsolidasi Order)', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Putaway Suggestion (AI Rak)', free: false, pro: true, premium: true, enterprise: true },
      { name: 'WMS Workflow SOP', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Stock Opname', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Outbound Delivery', free: false, pro: true, premium: true, enterprise: true },
    ]
  },
  {
    title: 'Keuangan',
    ...
    features: [
      ...
      { name: 'Bank Reconciliation', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Tax Management', free: false, pro: true, premium: true, enterprise: true },
    ]
  },
  {
    title: 'CRM & Marketing',
    icon: Megaphone,
    features: [
      { name: 'Customer Master', free: '25 customer', pro: 'Unlimited', premium: 'Unlimited', enterprise: 'Unlimited' },
      { name: 'Customer Segmentation', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Marketing Automation', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Discount Management', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Loyalty Program', free: false, pro: true, premium: true, enterprise: true },
    ]
  },
  {
    ...
    icon: Users,
    features: [
      { name: 'Employee Management', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Sales Performance', free: false, pro: true, premium: true, enterprise: true },
      { name: 'User Management', free: '1 user', pro: '3 user', premium: '10 user', enterprise: 'Unlimited' },
    ]
  },
  {
  ...
  },
  {
    ...
    icon: Sparkles,
    features: [
      { name: 'Design Studio', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Audit Log', free: false, pro: true, premium: true, enterprise: true },
      { name: 'Export (Excel, PDF, Print)', free: false, pro: true, premium: true, enterprise: true },
...
export default function PricingPage({ store }) {
  ...
  const [successPlanId, setSuccessPlanId] = useState('pro');

  // Detect return from Mayar after successful payment
  useEffect(() => {
    if (searchParams.get('payment') === 'success') {
      const savedPlan = localStorage.getItem('pending_checkout_plan');
      if (savedPlan) {
        setSuccessPlanId(savedPlan);
  ...
  const handleCheckout = async () => {
    ...
    try {
      localStorage.setItem('pending_checkout_plan', selectedPlanForCheckout.id);
    ...
    <div className="space-y-8 max-w-6xl mx-auto pb-20">
        ...
        {Object.values(PLAN_TIERS).map((plan) => {
          ...
          return (
            <Card key={plan.id} className={`relative overflow-hidden flex flex-col justify-between transition-all duration-300 ${isPopular ? 'border-2 border-blue-500 shadow-xl shadow-blue-100 dark:shadow-blue-900/20 scale-[1.02]' : 'border-slate-200 dark:border-slate-800 dark:bg-slate-900/50 hover:shadow-lg'}`}>
              ...
              <CardContent className={`p-6 flex flex-col justify-between h-full space-y-5 ${isPopular ? 'pt-10' : ''}`}>
                  ...
                  <div className="space-y-2.5 min-h-[120px]">
                    {plan.id === 'enterprise' ? (
                      ...
                      <>
                        ...
                        {plan.notIncluded && plan.notIncluded.slice(0, 3).map((f, i) => (
                ...
                <div className="mt-6">
                  {isCurrent && isTrial && plan.id === 'pro' ? (
                    ...
                    <Button 
                      ...
                      className={`w-full h-11 rounded-xl font-bold text-sm transition-all hover:scale-[1.02] ${isPopular ? `bg-gradient-to-r ${plan.gradient} text-white hover:opacity-90 shadow-lg` : plan.id === 'premium' ? 'bg-gradient-to-r from-indigo-500 to-indigo-600 text-white hover:opacity-90 shadow-lg' : 'bg-slate-900 text-white hover:bg-slate-800'}`}
                    >
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-slate-50 dark:bg-slate-800/80 border-b border-slate-200 dark:border-slate-700">
                  <th className="text-left py-3 px-4 font-bold text-slate-700 dark:text-slate-200 w-1/4">Fitur</th>
                  <th className="text-center py-3 px-4 font-bold text-slate-500 dark:text-slate-400 w-1/4">Free</th>
                  <th className="text-center py-3 px-4 font-bold text-blue-600 dark:text-blue-400 w-1/4">Pro</th>
                  <th className="text-center py-3 px-4 font-bold text-indigo-600 dark:text-indigo-400 w-1/4">Premium</th>
                </tr>
              </thead>
              <tbody>
                {featureGroups.map((group) => (
                  <React.Fragment key={group.title}>
                    <tr className="bg-slate-50/50 dark:bg-slate-800/40">
                      <td colSpan={4} className="py-2.5 px-4 border-b border-slate-100 dark:border-slate-800">
                    ...
                    {group.features.map((f) => (
                      <tr key={f.name} className="border-b border-slate-50 dark:border-slate-800 hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors">
                        ...
                        <td className="py-2.5 px-4"><FeatureCell value={f.premium} /></td>
                      </tr>
                    ))}
                  </React.Fragment>
                ))}
        ...
        <CardContent className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              { q: 'Berapa kuota komunikasi (Email & WA)?', a: 'Free Trial mendapat 5 kuota komunikasi. Pro Plan berbayar mendapat 50 kuota per bulan, sedangkan Premium Plan mendapat 300 kuota per bulan (gabungan untuk Marketing, Invoice, dan Alert Stok) yang akan direset otomatis setiap awal siklus billing.' },
              { q: 'Apakah data aman?', a: 'Data dienkripsi dengan standar AES-256 dan disimpan di server cloud yang aman.' },
              { q: 'Apa batasan paket Free / Trial?', a: 'Limit Paket Free: Maksimal 50 transaksi penjualan, fitur ekspor (Excel/PDF/Print) terkunci, dan terdapat watermark pada struk. Upgrade ke Pro atau Premium untuk akses tanpa batas dan laporan profesional.' },
      ...
      <Dialog open={showPaymentSuccess} onOpenChange={setShowPaymentSuccess}>
        <DialogContent className="sm:max-w-[480px] p-0 overflow-hidden border-0 shadow-2xl">
          ...
          <DialogDescription className="sr-only">Paket Anda telah diaktifkan</DialogDescription>
          <div className="text-center p-8 space-y-5">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-600 leading-relaxed max-w-sm mx-auto">
                Paket <strong>{successPlanId === 'premium' ? 'Premium Plan' : 'Pro Plan'}</strong> Anda telah berhasil diaktifkan. 
            ...
            <div className="bg-slate-50 rounded-xl p-4 space-y-2 text-left">
              <div className="flex items-center gap-2 text-xs font-medium text-emerald-700">
                <CheckCircle2 className="w-3.5 h-3.5" /> Akses seluruh modul {successPlanId === 'premium' ? 'Premium' : 'Pro'} telah dibuka
              </div>
              <div className="flex items-center gap-2 text-xs font-medium text-emerald-700">
                <CheckCircle2 className="w-3.5 h-3.5" /> Kuota email & notifikasi: {successPlanId === 'premium' ? '300' : '50'}/bulan
              </div>
              <div className="flex items-center gap-2 text-xs font-medium text-emerald-700">
                <CheckCircle2 className="w-3.5 h-3.5" /> Limit produk: {successPlanId === 'premium' ? '10.000' : '1.000'} & foto: {successPlanId === 'premium' ? '5.000' : '500'}
              </div>
            </div>
            <Button 
              onClick={() => {
            ...
            >
              ...
              Mulai Gunakan {successPlanId === 'premium' ? 'Premium' : 'Pro'}
            </Button>
          </div>
        </DialogContent>
      </Dialog>
